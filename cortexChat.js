...
class CortexChat {
    constructor(jwt, agentUrl, semanticModels) {
        this.jwt = jwt;
    ...
    async _retrieveResponse(query, limit = 1) {
        ...
        const data = {
            ...
            semantic_model_file:this.semanticModels
        };
    ...
    async _parseResponse(response) {
        ...
        while (!done) {
            ...
            if (value) {
                ...
                const jsonresult = JSON.parse(chunk).message.content;
                results.push(jsonresult);
                //this._processSSELine(chunk);
